...
namespace Sandbox.UI {
    internal class ResourceEditor : AutoLayoutWindow<ResourceEditor> {
        ...
        protected override void Init() {
            ...
            resIconObject.transform.localPosition = new Vector3(-100f, 0f);
            ...
            _inputField.text = LocalizedTextManager.getText("resource_editor_input_default");
