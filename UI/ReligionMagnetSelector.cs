...
namespace Sandbox.UI {
    internal class ReligionMagnetSelector : AutoLayoutWindow<ReligionMagnetSelector> {
        ...
        private PowerButton _religionMagnetButton;
                ...
                if (elementIndex >= _religionElements.Count) {
                    ...
                    religionElement.GetComponent<Button>()
                        .onClick.AddListener(() => {
                            ...
                            _religionMagnetButton.clickButton();
                        });
        ...
        protected override void Init() {
            ...
            _religionMagnetButton = PowerButtonCreator.CreateGodPowerButton("religion_magnet",
                SpriteTextureLoader.getSprite("ui/icons/religion_magnet_icon"));
