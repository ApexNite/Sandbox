...
namespace Sandbox.UI {
    internal class CultureMagnetSelector : AutoLayoutWindow<CultureMagnetSelector> {
        ...
        private PowerButton _cultureMagnetButton;
                ...
                if (elementIndex >= _cultureElements.Count) {
                    ...
                    cultureElement.GetComponent<Button>()
                        .onClick.AddListener(() => {
                            ...
                            _cultureMagnetButton.clickButton();
                        });
        ...
        protected override void Init() {
            ...
            _cultureMagnetButton = PowerButtonCreator.CreateGodPowerButton("culture_magnet",
                SpriteTextureLoader.getSprite("ui/icons/culture_magnet_icon"));
